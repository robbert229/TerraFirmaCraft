...
{
    public static final Capability<ForgingHandler> CAPABILITY = CapabilityManager.get(new CapabilityToken<>() {});
    ...
    @Nullable
    public static ForgingHandler get(ItemStack stack)
    {
    ...
    {
        final @Nullable ForgingHandler forging = get(stack);
